      ...
      <div className="shd-container" style={{ maxWidth: 900 }}>
        ...
        <Section title="Quick start (7 steps)">
          ...
          <ol style={{ paddingLeft: "1.5rem", listStyle: "decimal" }}>
            ...
            <li>
              <strong>Target Annual Base Withdrawal.</strong> Your planned yearly spend in today's
        ...
        <Section title="The cash buffer (runway)">
          <p>
            ...
            <strong> Cash Buffer Target</strong> (default 36 months) so a market crash doesn't
            force you to sell equities at the bottom. When the buffer is short, the directive
            switches into a <em>Refill</em> mode; when it's overstuffed, into{" "}
            <em>Reverse-Shielding</em>.
          </p>
        </Section>
